...
#SBATCH --cpus-per-task=10  # ask for 8 cpus
...
#SBATCH --time=1-00:00:00 # ask that the job be allowed to run for 2 days, 2 hours, 30 minutes, and 2 seconds.  --time=2-02:30:02
...
python database.py --db ./output/evals.db --evals-dir ./output/evals/
